...
height: 44px; "><a href="main.jsp"> 지진감시계통 PLC</a></div>
	...
	<th width=27% style="background-color: #eeeeee; text-align: center;">점검항목</th>
	<th width=9% style="background-color: #eeeeee; text-align: center;">근거자료(관리적)</th>
	<th width=9% style="background-color: #eeeeee; text-align: center;">근거자료(물리적)</th>
