            ...
            <table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
             ...
             <tbody>
                ...
                <tr>
                 ...
                 <tr>
                   <td><input type=checkbox value="계정관리" name="account_manage">계정관리
                   <input type=checkbox value="암호화" maxlength="50" name="encryption">암호화
                   <input type=checkbox value="로그기록" maxlength="50" name="logging">로그기록
                   <input type=checkbox value="외부매체연결성" maxlength="50" name="exteral_connect">외부매체연결성</td>
                </tr>
               ...
               <tr>
                ...
                <tr>
                   <td><input type="text" class="form-control" placeholder="OS유형종류" name="os_type" maxlength="50"></td>
                </tr>
               <tr>
                   <td><input type="text" class="form-control" placeholder="장치용도" name="usage" maxlength="50"></td>
                </tr>
